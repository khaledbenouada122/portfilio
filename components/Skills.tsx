...
function Skills({skills}: Props) {
  return (
    ...
    className='md:mt-96 h-screen relative flex flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center items-center xl:space-y-0 mx-auto '>
